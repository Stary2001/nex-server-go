...
func Authentication_Login(username string) (rmcResult uint32, result NEX.Result, pid NEX.PID, ticket []byte, station NEX.RVConnectionData, name string) {
...
func Authentication_LoginEx(StrUserName string, OExtraData NEX.Data) (rmcResult uint32, returnValue NEX.Result, PidPrincipal NEX.PID, PbufResponse []byte, PConnectionData NEX.RVConnectionData, StrReturnMsg string) {
